...
export const GenerateIcon: React.FC = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M12 2a10 10 0 0 0-4.37 18.91" />
        <path d="M12 2a10 10 0 0 1 4.37 18.91" />
        <path d="m14 12-2 2-2-2" />
        <path d="M12 14V6" />
        <path d="m5 18 2.8-2.8" />
        <path d="m19 18-2.8-2.8" />
    </svg>
);
...
export const WritingHandIcon: React.FC = () => (
    <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-gray-700 dark:text-gray-300">
        <path d="M18.88 4.06a3.53 3.53 0 0 0-5 0L6 11.94v6h6l7.88-7.88a3.53 3.53 0 0 0 0-5Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        <path d="M3 21h12M3 17h10M3 13h8M3 9h6" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
);